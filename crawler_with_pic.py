...
def urls_from_excel_readability(excel_file, sheet_name, url_column, output_folder):
    ...
    for idx, url in enumerate(urls, start=1):
        try:
            ...
            cleaned_html = readable_doc.summary()  # Main article content
            ...
            # Extract elements in order: headings, paragraphs, lists, images
            for element in soup.find_all(['h1', 'h2', 'h3', 'h4', 'h5', 'p', 'li', 'img']):
                if element.name == 'img':
...
if __name__ == "__main__":
    ...
    output_folder = "readability_article_pages"

    urls_from_excel_readability(excel_file, sheet_name, url_column, output_folder)
